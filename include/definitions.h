...
//#include <RtcDS3231.h>    Can't include RTC functions here, has to be before EepromAT24C32.h 
                         // so newer versions of RTC library work
...
OneButton Button(WIFI_BUTTON, true, true);      // active low with pullup
